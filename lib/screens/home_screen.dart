...
class HomeScreen extends StatefulWidget {
  ...
  static const String prefTotalScans = 'plantdoc_total_scans';
  static const String prefHealthyPlants = 'plantdoc_healthy_plants';
  static const String prefScanHistory = 'plantdoc_scan_history';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadPrefs() async {
    ...
    if (!mounted) return;
    setState(() {
      _totalScans = prefs.getInt(HomeScreen.prefTotalScans) ?? 0;
      _healthyPlants = prefs.getInt(HomeScreen.prefHealthyPlants) ?? 0;
      _scanHistory = prefs.getStringList(HomeScreen.prefScanHistory) ?? [];
    });
  }
